...
(function (ModelData) {
    var AjaxModel = (function (_super) {
        ...
        AjaxModel.prototype.getClassName = function () {
            var funcNameRegex = /function (.{1,})\(/;
            var results = (funcNameRegex).exec(this["constructor"].toString());
            return (results && results.length > 1) ? results[1] : "";
        };
...
(function (ModelData) {
    var StaticModel = (function (_super) {
        ...
        StaticModel.prototype.setData = function (data) {
            this.getDi().setPersistent(this.getIdentify(), JSON.stringify(data));
        };
        /**
         *
         */
        StaticModel.prototype.getData = function () {
            return this.getDi().getPersistent(this.getIdentify());
        };
        /**
         *
         */
        StaticModel.prototype.getObjectData = function () {
            return JSON.parse(this.getDi().getPersistent(this.getIdentify()));
        };
        /**
         *
         */
         ...
         *
         */
        StaticModel.prototype.getSerialized = function () {
        };
        return StaticModel;
    }(ModelData.RawModel));
...
(function (ModelData) {
    var AjaxModelPersistent = (function (_super) {
        ...
        AjaxModelPersistent.prototype.getClassName = function () {
            var funcNameRegex = /function (.{1,})\(/;
            var results = (funcNameRegex).exec(this["constructor"].toString());
            return (results && results.length > 1) ? results[1] : "";
        };
...
(function (Persistence) {
    var Filter = (function () {
         ...
         *
         */
        Filter.prototype.getMultipleRowValues = function (response, conds) {
    ...
    var EntityManager = (function () {
        ...
        EntityManager.prototype.checkModel = function (fn, type, model, objModel, params) {
            if (objModel instanceof ModelData.AjaxModelPersistent) {
                ...
                console.log(data);
                if (typeof data != null) {
                    this.setResponseAjax(fn, type, model, params);
                }
                else {
         ...
         *
         */
        EntityManager.prototype.setResponseAjax = function (fn, type, model, params) {
            this.ajax.response(function (response) {
                return fn(this.setResponse(response, type, model, params));
            }.bind(this));
            this.ajax.send();
        };
        /**
        ...
        EntityManager.prototype.setResponseStatic = function (fn, objModel, type, model, params) {
            fn(this.setResponse(objModel.getData(), type, model, params));
        };
        /**
         *
         */
        EntityManager.prototype.setResponse = function (data, type, model, params) {
            var resultSet = new Array();
            switch (type) {
                case "findOne":
                    resultSet = this.getResultSet(data, params, model);
                    if (resultSet != false) {
...
(function (View) {
    ...
    var ViewElement = (function () {
         ...
         *
         */
        ViewElement.prototype.getAttr = function (attr) {
...
(function (View) {
    ...
    var Table = (function (_super) {
        ...
        function Table(ctx, a1, a2, a3, a4, a5) {
            ...
            this.setDi(ctx.getDi());
            this.em = this.getDi().get("em");
            this.thead = new View.Thead(this.getContext());
            this.tbody = new View.Tbody(this.getContext());
            this.tfoot = new View.Tfoot(this.getContext());
            this.setArgs(this.getArguments(arguments));
            this.initialize();
        }
        /**
