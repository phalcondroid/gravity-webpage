...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="<?= $this->url->get('img/gravity.png') ?>"/>
        ...
        <?= $this->tag->javascriptInclude('js/gravity.js') ?>
        <?= $this->tag->javascriptInclude('js/Output/gravity-webpage.js') ?>
    </head>
    <body>
        <?= $this->getContent() ?>
    </body>
    ...
    <script type="text/javascript">
        ...
        Config.AppConfig.baseUrl = "<?= $this->url->get() ?>";
        gravity.setScope(
